import { Autocomplete, Box, Button, Divider, FormControl, InputLabel, MenuItem, Select, Stack, TextField } from "@mui/material"
    ...
    return (
        <Stack spacing={2} sx={{ py: 2 }}>
            <Autocomplete
                ...
                options={top100Films}
                sx={{ width: "100%" }}
                renderInput={(params) => <TextField {...params} placeholder="Agrega un producto" />}
            />
